...
const Login = () => {
    ...
    const goToAdminPage = () => {
        ...
        console.log("going to admin paage");
    };
            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center">
                <div className="w-1/3 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    ...
                    <button
                        ...
                        className="w-full mt-4 px-4 py-2 bg-gray-600 text-white font-medium rounded-lg hover:bg-gray-700 hover:shadow-xl transition duration-300"
                    >
                        Go to Admin page
                    </button>
                </div>
